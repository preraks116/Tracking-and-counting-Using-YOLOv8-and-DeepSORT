...
# "D:\\Two_Wheeler_vids\\trimmed\\Rec17\\Rec17-86.mp4"
    ...
    for file_name in l:
        ...
        new_clk_value = ''
        skip = False
        # source = "D:\\\\\\\\\\\\\\\\yolov5_detection\\\\\\\\6-june-2023\\\\New\\\\" + file_name + ".mp4"
        source = file_name
        source = str(source)
        ...
        for path, im, im0s, vid_cap, s in dataset:
            ...
            for i, det in enumerate(pred):  # per image
                ...
                if ctr == 0:
                    rect2Points = [(105, 831), (193, 858)]
                    #rect2Points = [(104, 844), (193, 867)]
                    #print("rect2Points: "+ str(rect2Points))
                ...
                if (len(det) and (new_clk_value != old_clk_value)):
                    ...
                    with open(file_name + '.csv', 'a') as f_object:
